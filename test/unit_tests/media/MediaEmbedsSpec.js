    ...
    describe(`${type} creation`, function() {
      ...
      describe('YouTube', function() {
        ...
        it('removes autoplay param from url (https://www.youtube-nocookie.com/watch?v=oHg5SJYRHA0&autoplay=1)', function() {
          ...
          const webview = '<a href="https://www.youtube-nocookie.com/watch?v=oHg5SJYRHA0&autoplay=1" target="_blank" rel="nofollow">https://www.youtube-nocookie.com/watch?v=oHg5SJYRHA0&autoplay=1</a><div class="iframe-container iframe-container-video"><webview class="youtube" style="display:inline-flex; width:100%; height:100%" src="https://www.youtube-nocookie.com/embed/oHg5SJYRHA0?html5=1&amp;enablejsapi=0&amp;modestbranding=1&amp;rel=0" frameborder="0" allowfullscreen="true"></webview></div>';
        ...
        return it('removes autoplay param from url (variation) (https://www.youtube-nocookie.com/watch?autoplay=1&v=oHg5SJYRHA0)', function() {
          ...
          const webview = '<a href="https://www.youtube-nocookie.com/watch?autoplay=1&v=oHg5SJYRHA0" target="_blank" rel="nofollow">https://www.youtube-nocookie.com/watch?autoplay=1&v=oHg5SJYRHA0</a><div class="iframe-container iframe-container-video"><webview class="youtube" style="display:inline-flex; width:100%; height:100%" src="https://www.youtube-nocookie.com/embed/oHg5SJYRHA0?html5=1&amp;enablejsapi=0&amp;modestbranding=1&amp;rel=0" frameborder="0" allowfullscreen="true"></webview></div>';
