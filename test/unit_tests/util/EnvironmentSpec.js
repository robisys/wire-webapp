...
describe('EnvironmentSpec', function() {
  ...
  describe('z.util.Environment._desktop_version', function() {
    it('detects wrapper version for internal', function() {
      ...
      expect(z.util.Environment._desktop_version(user_agent)).toBe('2.14.2744');
    });
    ...
    it('detects wrapper version for public', function() {
      ...
      expect(z.util.Environment._desktop_version(user_agent)).toBe('2.13.2734');
    });
    ...
    it('return undefined if no version is present', function() {
      ...
      expect(z.util.Environment._desktop_version(user_agent)).not.toBeDefined();
    });
  });
